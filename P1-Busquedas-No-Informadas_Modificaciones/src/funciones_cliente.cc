...
void GenerarOutput(const SearchResult& resultado, const Grafo& grafo, int origen, int destino, 
  ...
  archivo << "Nodo seleccionado entre mejor y peor: " << resultado.nodo_seleccionado << "\n";
  archivo << "Numero intentos totales:" << resultado.numero_intentos << "\n";
  archivo << "--------------------------------------------------\n\n";
  // Iteraciones
...
void Menu(Grafo& grafo, int origen, int destino, const std::string& outputfile) {
  ...
  std::cout << "1. BFS Multiarranque (Búsqueda en Amplitud)\n"; // MODIFICADA
